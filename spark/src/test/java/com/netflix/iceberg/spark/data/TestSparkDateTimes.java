...
import org.apache.spark.sql.catalyst.util.LegacyDateTimeFormatter;
...
public class TestSparkDateTimes {
  ...
  public void checkSparkTimestamp(String timestampString, String sparkRepr) {
    ...
    String sparkTimestamp = DateTimeUtils.timestampToString(ts.value(), DateTimeUtils.defaultTimeZone());
